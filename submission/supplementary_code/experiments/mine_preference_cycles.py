...
Added threshold-dependent inconsistency analysis for HH-RLHF.
Key finding: 30% of pairs exceed r≥0.8 (severe inconsistency).
Added harmonic risk distribution visualization (Figure 5 in paper).
See Section 5.5 (Scale Experiments: Anthropic HH-RLHF) in paper.
