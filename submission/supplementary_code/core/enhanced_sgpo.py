...
Added geodesic cost formulation for high-dimensional navigation (d=768).
Key method: compute_geodesic_cost() for path-length penalties.
Validates curved detour behavior in embedding space (Table 6 in paper).
See Section 5.6 (High-Dimensional Navigation) in paper.
...
# NOTE: These imports reference sibling modules in this package.
# If running standalone, ensure all modules are in the same directory.
