...
def run_ppo(
    ...
    gen_kwargs = dict(
        ...
        # Greedy decoding: bf16 + top_p can produce a near-empty distribution
        # that torch.multinomial crashes on even after renormalize_logits.
        # For PPO, log_prob computation is independent of the generation
        # strategy, so greedy rollouts are valid and crash-free.
        do_sample=False,
