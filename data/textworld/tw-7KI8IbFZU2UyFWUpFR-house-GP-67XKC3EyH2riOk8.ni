...
Test quest0_0 with "take shadfly from safe / go south / insert shadfly into drawer"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is how to play! First, it would be good if you could retrieve the shadfly from the safe. The".
The objective part 1 is some text that varies. The objective part 1 is "n, attempt to take a trip south. If you can finish that, you can insert the shadfly inside the drawer within the restroom. And once you've done that, you win!".
