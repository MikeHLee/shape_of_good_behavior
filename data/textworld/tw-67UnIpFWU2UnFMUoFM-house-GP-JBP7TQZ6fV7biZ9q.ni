...
The study part 1 is some text that varies. The study part 1 is " portmanteau.[if c_0 is open and there is something in the c_0] The portmanteau contains [a list of things in the c_0]. Now why would someone leave that there?[end if]".
The study part 2 is some text that varies. The study part 2 is "[if c_0 is open and the c_0 contains nothing] The portmanteau is empty! This is the worst thing that could possibly happen, ever![end if]".
...
The sauna part 0 is some text that varies. The sauna part 0 is "You've entered a sauna. You start to take note of what's in the room.
...
Test quest0_0 with "open portmanteau / take chocolate bar from portmanteau / eat chocolate bar"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to open the portmanteau within the study. And then, ".
The objective part 1 is some text that varies. The objective part 1 is "take the chocolate bar from the portmanteau inside the study. And then, eat the chocolate bar. That's it!".
