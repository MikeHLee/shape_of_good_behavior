...
The study part 0 is some text that varies. The study part 0 is "You find yourself in a study. A standard kind of place. The room is well lit.

 You can see [if c_0 is locked]a locked[else if c_0 is open]an opened[otherwise]a closed[end if]".
The study part 1 is some text that varies. The study part 1 is " safe in the room.[if c_0 is open and there is something in the c_0] The safe contains [a list of things in the c_0].[end if]".
...
The study part 3 is some text that varies. The study part 3 is " You make out a bureau.[if c_1 is open and there is something in the c_1] The bureau contains [a list of things in the c_1].[end if]".
The study part 4 is some text that varies. The study part 4 is "[if c_1 is open and the c_1 contains nothing] What a letdown! The bureau is empty![end if]".
The study part 5 is some text that varies. The study part 5 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The study part 6 is some text that varies. The study part 6 is " passageway leading west. There is an unguarded exit to the south.".
...
The workshop part 0 is some text that varies. The workshop part 0 is "You've just sauntered into a workshop.
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The workshop part 1 is some text that varies. The workshop part 1 is " passageway leading east. You don't like doors? Why not try going south, that entranceway is unblocked.".
...
The lounge part 0 is some text that varies. The lounge part 0 is "Well I'll be, you are in a place we're calling a lounge.
...
Test quest0_0 with "lock safe with passkey"
...
The objective part 0 is some text that varies. The objective part 0 is "Your objective is to lock the safe in the study with the passkey.".
