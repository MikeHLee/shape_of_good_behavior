...
The basement part 2 is some text that varies. The basement part 2 is " What's that over there? It looks like it's a display.[if c_1 is open and there is something in the c_1] The display contains [a list of things in the c_1]. The light flickers for a second, but nothing else happens.[end if]".
The basement part 3 is some text that varies. The basement part 3 is "[if c_1 is open and the c_1 contains nothing] The display is empty, what a horrible day![end if]".
...
Test quest0_0 with "take passkey from display / unlock chest with passkey"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First stop, pick up the passkey from the display. Then, doublecheck that the chest in the basement is un".
The objective part 1 is some text that varies. The objective part 1 is "locked with the passkey. Once that's all handled, you can stop!".
