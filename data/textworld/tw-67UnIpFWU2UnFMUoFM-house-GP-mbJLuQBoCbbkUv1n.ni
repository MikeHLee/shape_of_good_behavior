...
Test quest0_0 with "go south / open case / insert spork into case"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another profound round of TextWorld! Here is your task for today. First off, make an attempt to head south. And then, doublecheck that the case within the cubicle is wide open. After that, ".
The objective part 1 is some text that varies. The objective part 1 is "insert the spork inside the case. That's it!".
