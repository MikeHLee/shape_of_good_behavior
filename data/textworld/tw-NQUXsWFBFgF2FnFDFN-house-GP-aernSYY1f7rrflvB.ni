...
The spare room part 0 is some text that varies. The spare room part 0 is "You've just sauntered into a spare room. You can barely contain your excitement.

 You can make out [if c_0 is locked]a locked[else if c_0 is open]an opened[otherwise]a closed[end if]".
The spare room part 1 is some text that varies. The spare room part 1 is " type 8 chest.[if c_0 is open and there is something in the c_0] The type 8 chest contains [a list of things in the c_0].[end if]".
The spare room part 2 is some text that varies. The spare room part 2 is "[if c_0 is open and the c_0 contains nothing] The type 8 chest is empty, what a horrible day![end if]".
...
The bar part 0 is some text that varies. The bar part 0 is "You are in a bar. An usual kind of place.
 ...
 You make out a rectangular chest.[if c_1 is open and there is something in the c_1] The rectangular chest contains [a list of things in the c_1].[end if]".
The bar part 1 is some text that varies. The bar part 1 is "[if c_1 is open and the c_1 contains nothing] The rectangular chest is empty! What a waste of a day![end if]".
...
The k_1 and the k_2 are keys.
The k_1 and the k_2 are privately-named.
The r_2 and the r_0 and the r_1 are rooms.
The r_2 and the r_0 and the r_1 are privately-named.

The description of c_0 is "The type 8 chest looks strong, and impossible to crack. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
The printed name of c_0 is "type 8 chest".
Understand "type 8 chest" as c_0.
...
Test quest0_0 with "eat loaf of bread"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a profound session of TextWorld! Your task for today is to eat the loaf of bread.".
